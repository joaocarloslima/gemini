  ...
  <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top text-white" id="navigation-example">
    <div class="container">
      <div class="navbar-wrapper">
        <a class="navbar-brand" href="#pablo">GEMINI - Entrar no Sistema</a>
      </div>
          ...
          <form class="form" method="POST" action="logar.php">
            <div class="card card-login card-hidden">
              <div class="card-header card-header-rose text-center">
                <h4 class="card-title">Login do Professor</h4>
              </div>
              <div class="card-body ">
                ...
                <span class="bmd-form-group">
                  <div class="input-group">
                    ...
                    <input type="text" name="login" class="form-control" placeholder="nome de usuário" autocomplete="username">
                  </div>
                </span>
                <span class="bmd-form-group">
                  <div class="input-group">
