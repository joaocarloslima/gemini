    ...
    <div class="sidebar" data-color="azure" data-background-color="black" data-image="assets/img/sidebar-1.jpg">
      ...
      <div class="sidebar-wrapper">
        ...
        <ul class="nav">
          ...
          <li class="nav-item <?php echo (basename($_SERVER['PHP_SELF'])=='alunos.php')?'active':''; ?>">
            <a class="nav-link" href="alunos.php">
              <i class="fas fa-user-graduate"></i>
              <p> Alunos </p>
            </a>
          </li>
          <li class="nav-item <?php echo (basename($_SERVER['PHP_SELF'])=='missoes.php' || basename($_SERVER['PHP_SELF'])=='fases.php' || basename($_SERVER['PHP_SELF'])=='avaliar_fase.php')?'active':''; ?>">
